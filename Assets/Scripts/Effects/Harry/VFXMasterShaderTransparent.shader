Shader "VFX/VFXMasterShaderTransparent"
{
    Properties
    {
        ...
        [Space(20)]
        [Toggle(TERTIARY_TEX)]
        _ThirdTex("Second texture", float) = 0
        _TertiaryTex("Tertiary texture", 2D) = "white" {}
        _TertiaryPanningSpeed("Tertiary panning speed", Vector) = (0,0,0,0)

        [Space(20)]
        [Toggle(HORIZONTAL)]
        _Horizontal("Horizontal Gradient", float) = 0
        _HorizontalTex("Horizontal Gradient", 2D) = "white" {}
        _HorizontalStrength("Horizontal Strength", Range(1.5, 0)) = 1
